<template>
  <div ref="overlayFrame" class="overlayFrame lips">
    <canvas
      ref="lips"
      id="lips"
      class="overlay"
...
export default {
  ...
  methods: {
    ...
    clearCanvas() {
      ...
      //   ctx.stroke();
      // };
      // clearCanvasRect(this.$refs.lips);
    },
    layoutUpdate() {
      if (this.rect && this.frame_rect.width && this.frame_rect.height) {
        ...
        this.$refs.lips.style.width = `${this.frame_rect.width}px`;
        this.$refs.lips.style.height = `${this.frame_rect.height}px`;
      }
    }
  },
