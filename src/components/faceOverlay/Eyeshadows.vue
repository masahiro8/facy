<template>
  <div ref="overlayFrame" class="overlayFrame eyeshadows">
    <canvas
      ref="eyeshadows"
      id="eyeshadows"
      class="overlay"
...
export default {
  ...
  methods: {
    ...
    clearCanvas() {
      ...
      //   ctx.stroke();
      // };
      // clearCanvasRect(this.$refs.eyeshadows);
    },
    layoutUpdate() {
      if (this.rect && this.frame_rect.width && this.frame_rect.height) {
        ...
        this.$refs.eyeshadows.style.width = `${this.frame_rect.width}px`;
        this.$refs.eyeshadows.style.height = `${this.frame_rect.height}px`;
      }
    }
  },
